...
<body>
    ...
    <form action="ajouter.php" method="post">
        <h3>Identification Materiel</h3>

        no_serie : <input type="text" name="no_serie"><br>
        nom : <input type="text" name="nom"><br>
        type : <input type="text" name="type"><br>
        modele : <input type="number" name="modele"><br>
        statut : <input type="text" name="statut"><br>
        date d'entrée : <input type="date" name="dateEn"><br>
        prestataire : <select name="prestataire">
            <?php
