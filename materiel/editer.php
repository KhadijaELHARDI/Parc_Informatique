...
<body>
  ...
  <form action="modifierMat.php" method="post" enctype="multipart/form-data">
    
                    <h3>Modifier Materiel</h3>
      no_serie : <input type="text" name="no_serie" value="<?php echo $result['no_serie']; ?>"><br>
      nom : <input type="text" name="nom" value="<?php echo $result['nom']; ?>"><br>
      type : <input type="text" name="type" value="<?php echo $result['type']; ?>"><br>
      modele            : <input type="number" name="modele" value="<?php echo $result['modele']; ?>" ><br>
      statut            : <input type="text" name="statut" value="<?php echo $result['statut']; ?>"><br>
      date d'entrée     : <input type="date" name="dateEn" value="<?php echo $result['dateEn']; ?>"><br>
